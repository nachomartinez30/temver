...
import img_1 from '../assets/img/services_1.jpg'
import img_2 from '../assets/img/services_2.jpg'
import img_3 from '../assets/img/services_3.jpg'
        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col">
                    <div className="h-1 bg-blue rounded overflow-hidden">
                        <div className="w-24 h-full bg-green" />
                    </div>
